...
RSpec.describe "pages", type: :request do
  context "default" do
    it "should display the page header" do
      get Lookbook.pages.find_by_path("with_header").url_path
      expect(html).to have_css("#page-header")
    end

    it "should display the page content" do
      get Lookbook.pages.find_by_path("overview").url_path
  ...
  context "with tabs" do
    it "should display the tabs" do
      get Lookbook.pages.find_by_path("sections").url_path
  ...
  context "with code helper" do
    it "should display the highlighted code" do
      get Lookbook.pages.find_by_path("code").url_path

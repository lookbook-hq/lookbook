...
})({"6RrWd":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = 1234;
var HMR_SECURE = false;
var HMR_ENV_HASH = "916932b22e4085ab";
module.bundle.HMR_BUNDLE_ID = "f6c75d93577f27fe";
...
},{}],"aY0Op":[function(require,module,exports) {
var _iframeResizerContentWindow = require("iframe-resizer/js/iframeResizer.contentWindow");

},{"iframe-resizer/js/iframeResizer.contentWindow":"8bge9"}],"8bge9":[function(require,module,exports) {
(function(undefined) {
    ...
    var autoResize = true, base = 10, bodyBackground = '', bodyMargin = 0, bodyMarginStr = '', bodyObserver = null, bodyPadding = '', calculateWidth = false, doubleEventList = {
        resize: 1,
        click: 1
    }, eventCancelTimer = 128, firstRun = true, height1 = 1, heightCalcModeDefault = 'bodyOffset', heightCalcMode = heightCalcModeDefault, initLock = true, initMsg = '', inPageLinks = {
    }, interval = 32, intervalTimer = null, logging = false, mouseEvents = false, msgID = '[iFrameSizer]', msgIdLen = msgID.length, myID = '', resetRequiredMethods = {
        max: 1,
        min: 1,
        bodyScroll: 1,
    ...
    function addEventListener(el, evt, func, options) {
        el.addEventListener(evt, func, passiveSupported ? options || {
        } : false);
    }
...
},{}]},["6RrWd","aY0Op"], "aY0Op", "parcelRequirea49c")

...
function inspector() {
    return {
        ...
        toggleView: function() {
            this.$store.inspector.preview.view = this.view === "html" ? "preview" : "html";
        },
...
function param(name, value) {
    return {
        ...
        init: function() {
            var _this = this;
            this.$watch("value", _debounceDefault.default(function() {
                if (_this.validate()) _this.update();
            }, 300));
        },
        setFocus: function() {
            var _this = this;

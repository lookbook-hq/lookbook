...
var require_ui_001 = __commonJS({
  "lookbook-assets/ui-KbINuEBn.js"(exports, module) {
    ...
    var root_4$2 = /* @__PURE__ */ from_html(`<textarea></textarea>`);
    ...
    const usePresence = (props) => {
      ...
      const api = /* @__PURE__ */ user_derived(() => connect$5(service));
    ...
    var anatomy$4 = createAnatomy("tabs").parts("root", "list", "trigger", "content", "indicator");
  ...
  `;
    ...
    var anatomy$3 = createAnatomy("splitter").parts("root", "panel", "resizeTrigger", "resizeTriggerIndicator");
    var parts$4 = anatomy$3.build();
    ...
    const useField = (inProps = {}) => {
      ...
      const getInputProps = () => ({ ...getControlProps(), ...parts$2.input.attrs });
      const getTextareaProps = () => ({ ...getControlProps(), ...parts$2.textarea.attrs });
      const getSelectProps = () => ({ ...getControlProps(), ...parts$2.select.attrs });
      ...
      const getRequiredIndicatorProps = () => ({ "aria-hidden": true, ...parts$2.requiredIndicator.attrs });
    ...
    var anatomy$1 = createAnatomy("tree-view").parts(
      "branch",
      "branchContent",
      "branchControl",
      "branchIndentGuide",
      ...
      each(ol, 21, crumbs, (crumb) => crumb.id, ($$anchor2, crumb) => {
        ...
        var node = child(li);
        {
          var consequent = ($$anchor3) => {
            Link($$anchor3, {
              get href() {
                return get$3(crumb).href;
              },
              children: ($$anchor4, $$slotProps) => {
                var text$1 = text();
                template_effect(() => set_text(text$1, get$3(crumb).label));
          ...
          var alternate = ($$anchor3) => {
            ...
            template_effect(() => set_text(text_1, get$3(crumb).label));
            append$1($$anchor3, span);
          };
          if_block(node, ($$render) => {
            if (get$3(crumb).href) $$render(consequent);
            else $$render(alternate, false);
          });
        }
        append$1($$anchor2, li);
    ...
    function Show$2($$anchor, $$props) {
      push($$props, true);
      let data = /* @__PURE__ */ rest_props($$props, ["$$slots", "$$events", "$$legacy"]);
      const collection2 = getCurrentContext().collection;
      Inspector($$anchor, spread_props(
        {
          get collection() {
            return collection2;
          }

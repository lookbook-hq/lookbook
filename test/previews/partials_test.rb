...
module Lookbook
  class PhlexTest < ActionDispatch::IntegrationTest
    test "renders view partial previews" do
      get lookbook_preview_path("test_suite_previews/partial_rendering/default")
    ...
    test "supports helpers" do
      ...
      get lookbook_preview_path("test_suite_previews/partial_rendering/helpers")
    ...
    test "has access to host app url helpers" do
      ...
      get lookbook_preview_path("test_suite_previews/partial_rendering/url_helpers")

      assert_link "/blog"
    end

    test "does not support content_for by default" do
      get lookbook_preview_path("test_suite_previews/partial_rendering/content_for")

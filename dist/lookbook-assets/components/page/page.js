...
#content {
  max-width: var(--lookbook-page-max-width);
}
`;var z=class extends st{constructor(){super(...arguments);this.title=""}render(){return mt`
      <lb-toolbar
        id="toolbar"
        divider="block-end"
      >
    ...
    `}};z.css=Te,A([N()],z.prototype,"title",2),z=A([zt("lb-page")],z);export{z as LookbookPage};

...
`;var x=class extends Oe(B){constructor(){super(...arguments);this.type="button";this.appearance="button";this.role="button";this.disabled=!1;this.active=!1;this.popoverPlacement="bottom-end"}get commandForTarget(){return this.commandFor?this.shadowRoot.getElementById(this.commandFor):void 0}get isLink(){return typeof this.href=="string"}firstUpdated(){this.id=this.id||Re()}handlePopoverShow(o){this.active=!0,this.dispatch("lb-popover-open",{popover:o.target})}handlePopoverHide(o){this.dispatch("lb-popover-close",{popover:o.target}),this.active=!1}renderPopover(){return Zt`
    ...
    `}handleTooltipChange(o){let r=o.target?.assignedElements()?.[0];r&&(r.for=this.id)}handleClick(o){this.isLink&&(this.dispatch("lb-command","visit",{url:this.href}),o.preventDefault())}render(){let o=this.isLink?Gt`a`:Gt`button`;return Zt`
      <${o}
        id="button"
        part="button"
    ...
    `}};x.shadowRootOptions={...B.shadowRootOptions,delegatesFocus:!0},x.css=Ue,g([E()],x.prototype,"href",2),g([E()],x.prototype,"label",2),g([E()],x.prototype,"type",2),g([E()],x.prototype,"target",2),g([E({reflect:!0})],x.prototype,"appearance",2),g([E({reflect:!0})],x.prototype,"role",2),g([E({type:Boolean,reflect:!0})],x.prototype,"disabled",2),g([E({type:Boolean,reflect:!0})],x.prototype,"active",2),g([E({attribute:"popover-placement"})],x.prototype,"popoverPlacement",2),g([E({attribute:"commandfor",type:String,reflect:!0})],x.prototype,"commandFor",2),g([E({attribute:"command",type:String})],x.prototype,"command",2),g([A()],x.prototype,"commandForTarget",1),g([A()],x.prototype,"isLink",1),x=g([Bt("lb-button")],x);export{x as LookbookButton};
